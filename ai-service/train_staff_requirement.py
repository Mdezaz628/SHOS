...
print("[INFO] Loading staff requirement training data...")
...
TARGET = "actual_total_staff_requirement"
...
model_path = "models/staff_requirement_model.joblib"
