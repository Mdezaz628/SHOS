...
prediction = (
    ...
    .select("id,prediction_code,prediction_value,prediction_label,risk_level,target_date")
    .eq("target_entity", "staff_workload")
...
if not prediction.data:
    raise Exception("No staff workload prediction found.")
...
print("Workload:", p["prediction_value"])
print("Label:", p["prediction_label"])
print("Risk:", p["risk_level"])

result = supabase.rpc(
    "generate_staff_workload_recommendation",
    {
