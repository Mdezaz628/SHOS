...
prediction = (
    ...
    .eq("target_entity", "hospital_operational_anomaly")
...
if not prediction.data:
    raise Exception("No anomaly prediction found.")
...
print("Anomaly Score:", p["prediction_value"])
print("Label:", p["prediction_label"])
print("Risk:", p["risk_level"])

result = supabase.rpc(
    "generate_anomaly_detection_recommendation",
    {
